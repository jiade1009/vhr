...
export default {
  ...
  data() {
    return {
      ...
      beanlist: [],
      tableColumns: [
        {prop: "yearResearch", label: "年份", show: true},
        {prop: "totalBegin", label: "初始总市值", show: true},
        {prop: "totalEnd", label: "总市值", show: true},
        {prop: "profit", label: "当年盈亏", show: true},
        {prop: "profitRate", label: "当年盈亏率", show: true},
  ...
  methods: {
    ...
    initBeanlist() {
      this.loading = true;
      let url = '/' + this.flag + '/profityear/?page=' + this.page + '&size=' + this.size;
